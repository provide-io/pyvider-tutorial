#!/usr/bin/env bash
# Record the Part 2 tutorial demo.
# Outputs: $OUT_DIR/tutorial-part2-data-source.cast (default: <repo>/casts/)
#
# Usage: ./scripts/record-part2.sh [output-dir]
# Requires: uv, tofu (or terraform), pyvider>=0.3.33

set -euo pipefail
SCRIPT_DIR="$(cd "$(dirname "$0")" && pwd)"
REPO_ROOT="$(dirname "$SCRIPT_DIR")"
PART_NAME="part2-data-source"
CAST_BASE="tutorial-part2-data-source"
