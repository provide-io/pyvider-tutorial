#!/usr/bin/env bash
# Record the Part 1 tutorial demo: resource CRUD.
# Outputs: $OUT_DIR/tutorial-part1-resource.cast (default: <repo>/casts/)
#
# Usage: ./scripts/record-part1.sh [output-dir]
# Requires: uv, tofu (or terraform), pyvider>=0.3.33

set -euo pipefail
SCRIPT_DIR="$(cd "$(dirname "$0")" && pwd)"
REPO_ROOT="$(dirname "$SCRIPT_DIR")"
PART_NAME="part1-resource"
CAST_BASE="tutorial-part1-resource"
