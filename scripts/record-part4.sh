#!/usr/bin/env bash
# Record the Part 4 tutorial demo.
# Outputs: $OUT_DIR/tutorial-part4-ephemeral.cast (default: <repo>/casts/)
#
# Usage: ./scripts/record-part4.sh [output-dir]
# Requires: uv, tofu (or terraform), pyvider>=0.3.33

set -euo pipefail
SCRIPT_DIR="$(cd "$(dirname "$0")" && pwd)"
REPO_ROOT="$(dirname "$SCRIPT_DIR")"
PART_NAME="part4-ephemeral"
CAST_BASE="tutorial-part4-ephemeral"
